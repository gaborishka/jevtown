...
- **Your own audience, in words.** Say whom the text is for ("people who work in IT and are into startups"), and only the people in town who fit every part of it read it; the waves, the counts, the groups and the map are then about them. Nothing to connect: Jev reads the words, and the Audience tab shows how it read them. The town knows work, age, interests, money and shopping; words about anything else do not count.
